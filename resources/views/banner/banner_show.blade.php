...
@section('content')
                    ...
                    <div class="container-fluid my-2">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6 text-right a_btnn">
                                <a href="{{ route('banner.banner_add') }}" class="pull-right btn btn-success btn-lg"><i
                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->title }}</td>
                                    <td>{{ $d->ordering }}</td>
                                    <td><img height="170" width="100" src="{{ asset('all_images/' . $d->image) }}"
                                    ...
                                    <td>
                                        <a href="{{ route('banner.banner_update', $d->id) }}">
                                        ...
                                        <a href="{{ route('banner.banner_delete', $d->id) }}"
    ...
    <script>
        function toggleStatus(rowId) {
            $.ajax({
                url: '{{ route('banner.update-status') }}' + '?id=' + rowId,
                type: 'POST',
                dataType: 'json',
                data: {
                    _token: '{{ csrf_token() }}'
